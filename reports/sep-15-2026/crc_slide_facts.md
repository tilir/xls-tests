...
- Corrected ORFS ASAP7 P&R at a real 1000 ps constraint closes all four clocked modules: temporal WNS +838 ps, folded +569 ps, naive 128-bit pipeline +706 ps, and optimized 128-bit pipeline +746 ps. The previous negative result used an accidental 1 ps SDC constraint. Temporal is smallest (16.461 µm²); optimized is 31.5% smaller than naive (154.431 versus 225.596 µm²).
